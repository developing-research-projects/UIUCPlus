...
public class Tag implements Cloneable {
  ...
  private boolean selfClosing =
      false; // can self close (<foo />). used for unknown tags that self close, without forcing
             // them as empty.
  ...
  // todo - rework this to format contents as inline; and update html emitter in Element. Same
  // output, just neater.
