...
public class Rule {
   ...
   */
  public static Map<String, List<Rule>> getInstanceMap(
      final NameType nameType, final RuleType rt, final String abc) {
    final Map<String, List<Rule>> rules = RULES.get(nameType).get(rt).get(abc);
    if (rules == null) {
      throw new IllegalArgumentException(
          String.format("No rules found for %s, %s, %s.", nameType.getName(), rt.getName(), abc));
    }
    return rules;
  }
