...
public class Processor {
  ...
  /**
   * Gets the processor architecture as an {@link Arch} enum. The processor architecture defines, if
   * the processor has a 32 or 64 bit architecture.
   *
  ...
  /**
   * Gets the processor type as {@link Type} enum. The processor type defines, if the processor is
   * for example an x86 or PPA.
   *
