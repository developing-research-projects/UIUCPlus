...
public class StandardToStringStyle extends ToStringStyle {
  ...
  /**
   * Gets the text to output when a {@link Collection}, {@link Map} or {@link Array} size is output.
   *
  ...
  /**
   * Sets the start text to output when a {@link Collection}, {@link Map} or {@link Array} size is
   * output.
   *
   * <p>This is output before the size value.
   *
  ...
  /**
   * Gets the end text to output when a {@link Collection}, {@link Map} or {@link Array} size is
   * output.
   *
  ...
  /**
   * Sets the end text to output when a {@link Collection}, {@link Map} or {@link Array} size is
   * output.
   *
   * <p>This is output after the size value.
   *
