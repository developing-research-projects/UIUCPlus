 ...
 *
 * <p>The {@link Formattable} interface provides basic control over formatting when using a {@link
...
public class FormattableUtils {
  ...
  /**
   * {@link FormattableUtils} instances should NOT be constructed in standard programming. Instead,
  ...
  /**
   * Gets the default formatted representation of the specified {@link Formattable}.
   *
