...
public interface FailableFunction<T, R, E extends Throwable> {
   ...
   */
  default <V> FailableFunction<T, V, E> andThen(
      final FailableFunction<? super R, ? extends V, E> after) {
   ...
   */
  default <V> FailableFunction<V, R, E> compose(
      final FailableFunction<? super V, ? extends T, E> before) {
    if (before.equals(null)) throw new NullPointerException();
