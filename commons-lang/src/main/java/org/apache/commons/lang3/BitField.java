 ...
 *
 * <p>Each {@link BitField} is constructed with a mask value, which indicates the bits that will be
 ...
 * </pre>
 *
 * <p>Using these {@link BitField} instances, a paint instruction can be encoded into an integer:
 *
 * <pre>
...
public class BitField {
  ...
  public short setShortValue(final short holder, final short value) {
    short newValue = (short) (holder + value); // statement 1 changed
    return (short)
        setValue(
            holder,
            newValue); // statement 2 changed from return (short)setValue(holder, value) to return
                       // (short)setValue(holder, newValue)
  }
