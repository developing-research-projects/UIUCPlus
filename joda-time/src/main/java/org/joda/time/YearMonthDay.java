 ...
 *
 * <p>NOTE: This class only supports the three fields listed above. Thus, you cannot query the
 * dayOfWeek or centuryOfEra fields for example. The new <code>LocalDate</code> class removes this
 * restriction.
 *
 * <p>Calculations on YearMonthDay are performed using a {@link Chronology}. This chronology is set
 * to be in the UTC time zone for all calculations.
 *
 ...
 * </ul>
 *
 * <p>YearMonthDay is thread-safe and immutable, provided that the Chronology is as well. All
 * standard Chronology classes supplied are thread-safe and immutable.
 *
 * @author Stephen Colebourne
 * @since 1.0
 * @deprecated Use LocalDate which has a much better internal implementation and has been available
 *     since 1.3
 */
@Deprecated
public final class YearMonthDay extends BasePartial implements ReadablePartial, Serializable {
  ...
  // -----------------------------------------------------------------------
  /**
   * Constructs a YearMonthDay from a <code>java.util.Calendar</code> using exactly the same field
   * values avoiding any time zone effects.
   *
   * <p>Each field is queried from the Calendar and assigned to the YearMonthDay. This is useful if
   * you have been using the Calendar as a local date, ignoring the zone.
   *
   * <p>This factory method ignores the type of the calendar and always creates a YearMonthDay with
  ...
  /**
   * Constructs a YearMonthDay from a <code>java.util.Date</code> using exactly the same field
   * values avoiding any time zone effects.
   *
   * <p>Each field is queried from the Date and assigned to the YearMonthDay. This is useful if you
   * have been using the Date as a local date, ignoring the zone.
   *
   * <p>This factory method always creates a YearMonthDay with ISO chronology.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * Constructs a YearMonthDay with the current date, using ISOChronology in the default zone to
   * extract the fields.
   *
  ...
  /**
   * Constructs a YearMonthDay with the current date, using ISOChronology in the specified zone to
   * extract the fields.
   *
   * <p>The constructor uses the specified time zone to obtain the current date. Once the
  ...
  /**
   * Constructs a YearMonthDay with the current date, using the specified chronology and zone to
   * extract the fields.
   *
  ...
  /**
   * Constructs a YearMonthDay extracting the partial fields from the specified milliseconds using
   ...
   * ISODateTimeFormat#dateTimeParser()}. Time only strings are now rejected.
   *
  ...
  /**
   * Constructs a YearMonthDay from an Object that represents a time, using the specified
   * chronology.
   *
   * <p>The recognised object types are defined in {@link org.joda.time.convert.ConverterManager
   * ConverterManager} and include ReadableInstant, String, Calendar and Date. The String formats
  ...
  /**
   * Constructs a YearMonthDay with specified time field values using <code>ISOChronology</code> in
   * the default zone.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * Returns a copy of this date with the specified chronology. This instance is immutable and
   * unaffected by this method call.
   *
   * <p>This method retains the values of the fields, thus the result will typically refer to a
   * different instant.
   *
   * <p>The time zone of the specified chronology is ignored, as YearMonthDay operates without a
   * time zone.
   *
   ...
   *
   * <p>This date instance is immutable and unaffected by this method call.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * Converts this partial to a full datetime using the default time zone setting the date fields
  ...
  /**
   * Converts this partial to a full datetime using the specified time zone setting the date fields
   * from this instance and the time fields from the current time.
   *
   * <p>This method uses the chronology from this instance plus the time zone specified.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * Converts this object to a DateTime using a TimeOfDay to fill in the missing fields and using
   * the default time zone. This instance is immutable and unaffected by this method call.
   *
   * <p>The resulting chronology is determined by the chronology of this YearMonthDay plus the time
   * zone. The chronology of the time is ignored - only the field values are used.
   *
  ...
  /**
   * Converts this object to a DateTime using a TimeOfDay to fill in the missing fields. This
   ...
   *
   * <p>YearMonthDay is immutable, so there are no set methods. Instead, this method returns a new
  ...
  public static class Property extends AbstractPartialFieldProperty implements Serializable {
     ...
     *
     * <p>The YearMonthDay attached to this property is unchanged by this call. Instead, a new
    ...
    /**
     * Adds to the value of this field in a copy of this YearMonthDay wrapping within this field if
