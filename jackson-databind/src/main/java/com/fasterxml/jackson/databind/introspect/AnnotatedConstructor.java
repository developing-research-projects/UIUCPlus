...
public final class AnnotatedConstructor extends AnnotatedWithParams {
  ...
  public String toString() {
    ...
    return String.format(
        ...
        ClassUtil.nameOf(_constructor.getDeclaringClass()),
        argCount,
        (argCount == 1) ? "" : "s",
        _annotations);
  }
  ...
  /**
   * Helper class that is used as the workaround to persist Field references. It basically just
   * stores declaring class and field name.
   */
  private static final class Serialization implements java.io.Serializable {
    private static final long serialVersionUID = 1L;
