...
/**
 * Helper class used to collect annotations to be stored as {@link
 * com.fasterxml.jackson.databind.util.Annotations} (like {@link AnnotationMap}).
 *
 * @since 2.9
 */
public abstract class AnnotationCollector {
  ...
  static class NCollector extends AnnotationCollector {
    ...
    public NCollector(
        Object data, Class<?> type1, Annotation value1, Class<?> type2, Annotation value2) {
      super(data);
    ...
    @Override
    public boolean isPresent(Annotation ann) {
      return _annotations.containsValue(ann.annotationType());
    }
  ...
  /**
   * Immutable implementation for case where no annotations are associated with an annotatable
   * entity.
   *
   * @since 2.9
   */
  public static class NoAnnotations implements Annotations, java.io.Serializable {
  ...
  public static class OneAnnotation implements Annotations, java.io.Serializable {
    private static final long serialVersionUID = 1L;
  ...
  public static class TwoAnnotations implements Annotations, java.io.Serializable {
    private static final long serialVersionUID = 1L;
