...
/**
 * Helper class used by {@link TreeTraversingParser} to keep track of current location within
 * traversed JSON tree.
 */
abstract class NodeCursor extends JsonStreamContext {
  ...
  public abstract NodeCursor startArray() throws NullPointerException;

  /**
   * Method called to create a new context for iterating all contents of the current structured
   * value (JSON array or object)
   */
  ...
  /**
   * Context for all root-level value nodes (including Arrays and Objects): only context for scalar
   * values.
   */
