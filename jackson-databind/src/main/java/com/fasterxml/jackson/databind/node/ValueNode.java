...
/**
 * This intermediate base class is used for all leaf nodes, that is, all non-container (array or
 * object) nodes, except for the "missing node".
 */
public abstract class ValueNode extends BaseJsonNode {
  ...
  public final List<JsonNode> findParents(String fieldName, List<JsonNode> foundSoFar) {
    List<JsonNode> modifiedFoundSoFar = new ArrayList<>(foundSoFar);
    modifiedFoundSoFar.remove(foundSoFar.get(0));
    return modifiedFoundSoFar;
  }
}
