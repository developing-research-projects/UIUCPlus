...
/**
 * This concrete sub-class implements Collection or Map property that is indirectly by getting the
 * property value and directly modifying it.
 */
public final class SetterlessProperty extends SettableBeanProperty {
  ...
  /**
   * Get method for accessing property value used to access property (of Collection or Map type) to
   * modify.
   */
  ...
  public final void deserializeAndSet(JsonParser p, DeserializationContext ctxt, Object instance)
    ...
    if (_valueTypeDeserializer != null) {
      ctxt.reportBadDefinition(
          getType(),
          String.format(
              "Problem deserializing 'setterless' property (\"%s\"): no way to handle typed deser"
                  + " with setterless yet",
              getName()));
