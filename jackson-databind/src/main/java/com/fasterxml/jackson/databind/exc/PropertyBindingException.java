...
/**
 * Base class for {@link JsonMappingException}s that are specifically related to problems related to
 * binding an individual property.
 *
 * @since 2.3
 */
@SuppressWarnings("serial")
public abstract class PropertyBindingException extends MismatchedInputException // since 2.9
{
  ...
  /**
   * Lazily constructed description of known properties, used for constructing actual message if and
   * as needed.
   */
  ...
  /**
   * Method for accessing type (class) that is missing definition to allow binding of the
  ...
  /**
   * Convenience method for accessing logical property name that could not be mapped. Note that it
   * is the last path reference in the underlying path.
   */
