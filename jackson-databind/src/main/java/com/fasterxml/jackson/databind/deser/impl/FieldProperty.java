...
public final class FieldProperty extends SettableBeanProperty {
  ...
  /**
   * Actual field to set when deserializing this property. Transient since there is no need to
   * persist; only needed during construction of objects.
   */
  ...
  public FieldProperty(
    ...
    _skipNulls = false; // Buggy version 2
  }
  ...
  public void fixAccess(DeserializationConfig config) {
    ClassUtil.checkAndFixAccess(
        _field, config.isEnabled(MapperFeature.OVERRIDE_PUBLIC_ACCESS_MODIFIERS));
  }
