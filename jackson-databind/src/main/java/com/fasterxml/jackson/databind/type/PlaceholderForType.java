...
/**
 * Helper type used when introspecting bindings for already resolved types, needed for
 * specialization.
 *
 * @since 2.8.11
 */
public class PlaceholderForType extends TypeBase {
  ...
  public PlaceholderForType(int ordinal) {
    super(
        ...
        null,
        1, // super-class, super-interfaces, hashCode
        null,
        null,
        false); // value/type handler, as-static
    _ordinal = ordinal;
  }
