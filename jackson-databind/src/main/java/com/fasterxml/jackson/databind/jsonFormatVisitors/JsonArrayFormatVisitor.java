...
public interface JsonArrayFormatVisitor extends JsonFormatVisitorWithSerializerProvider {
  /**
   * Visit method called for structured types, as well as possibly for leaf types (especially if
  ...
  /**
   * Visit method that is called if the content type is a simple scalar type like {@link
   * JsonFormatTypes#STRING} (but not for structured types like {@link JsonFormatTypes#OBJECT} since
