...
public abstract class PropertyValue {
  ...
  public abstract void assign(Object bean) throws ClassNotFoundException;
  ...
  /**
   * Property value that used when assigning value to property using a setter method or direct field
   * access.
   */
  ...
  /**
   * Property value type used when storing entries to be added to a POJO using "any setter" (method
   * that takes name and value arguments, allowing setting multiple different properties using
   * single method).
   */
