...
/**
 * <a href="http://en.wikipedia.org/wiki/Sigmoid_function">Sigmoid</a> function. It is the inverse
 * of the {@link Logit logit} function. A more flexible version, the generalised logistic, is
 * implemented by the {@link Logistic} class.
 *
 * @since 3.0
 */
public class Sigmoid implements UnivariateDifferentiableFunction {
   ...
   * Sigmoid#Sigmoid(double,double) sigmoid function}. Ordered as follows:
   *
   * <ul>
   *   <li>Lower asymptote
   *   <li>Higher asymptote
  ...
  public static class Parametric implements ParametricUnivariateFunction {
     ...
     */
    @Override
    public double[] gradient(double x, double... param) throws DimensionMismatchException {
      validateParameters(param);
