...
public class LeastSquaresBuilder {
   ...
   * Configure the convergence checker.
   *
   * <p>This function is an overloaded version of {@link #checker(ConvergenceChecker)}.
   *
   * @param newChecker the convergence checker.
   * @return this
   */
  public LeastSquaresBuilder checkerPair(
      final ConvergenceChecker<PointVectorValuePair> newChecker) {
   ...
   * @return this
   */
  public LeastSquaresBuilder model(
  ...
  public LeastSquaresBuilder start(final double[] newStart) {
    return start(new ArrayRealVector(newStart, true));
  }
