...
/**
 * Computes a statistic related to the Second Central Moment. Specifically, what is computed is the
 ...
 * if there is just one value in the data set. Note that Double.NaN may also be returned if the
 * input includes NaN and / or infinite values.
 *
