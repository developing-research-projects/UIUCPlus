...
public class Sum extends AbstractStorelessUnivariateStatistic {
  ...
  /**
   * The sum of the entries in the specified portion of the input array, or 0 if the designated
   * subarray is empty.
   *
  ...
  /**
   * The weighted sum of the entries in the specified portion of the input array, or 0 if the
