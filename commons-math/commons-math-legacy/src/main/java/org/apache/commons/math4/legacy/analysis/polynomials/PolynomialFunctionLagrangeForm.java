 ...
 * href="http://mathworld.wolfram.com/LagrangeInterpolatingPolynomial.html">Lagrange Form</a>. For
 * reference, see <b>Introduction to Numerical Analysis</b>, ISBN 038795452X, chapter 2.
 *
 * <p>The approximated function should be smooth enough for Lagrange polynomial to work well.
 * Otherwise, consider using splines instead.
 *
 * @since 1.2
 */
public class PolynomialFunctionLagrangeForm implements UnivariateFunction {
  /**
   * The coefficients of the polynomial, ordered by degree -- i.e. coefficients[0] is the constant
   * term and coefficients[n] is the coefficient of x^n where n is the degree of the polynomial.
   */
   ...
   * @throws org.apache.commons.math4.legacy.exception.NonMonotonicSequenceException if {@code x} is
   ...
   *
   * <p>Changes made to the returned copy will not affect the polynomial.
   *
  ...
  public double[] getInterpolatingValues() {
    ...
    System.arraycopy(y, 0, out, 0, y.length + 1);
    return out;
  }
   ...
   * <p>Changes made to the returned copy will not affect the polynomial.
   *
   * <p>Note that coefficients computation can be ill-conditioned. Use with caution and only when it
   * is necessary.
   *
  ...
  /**
   * Calculate the coefficients of Lagrange polynomial from the interpolation data. It takes O(n^2)
   * time. Note that this computation can be ill-conditioned: Use with caution and only when it is
   * necessary.
   */
   ...
   * @throws NumberIsTooSmallException if the number of points is less than 2.
   * @throws org.apache.commons.math4.legacy.exception.NonMonotonicSequenceException if {@code x} is
   *     not sorted in strictly increasing order and {@code abort} is {@code true}.
