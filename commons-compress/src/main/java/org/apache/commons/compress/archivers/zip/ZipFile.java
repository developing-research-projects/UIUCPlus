...
public class ZipFile implements Closeable {
  ...
  public Enumeration<ZipArchiveEntry> getEntriesInPhysicalOrder() {
    final List<ZipArchiveEntry> entriesList =
        Arrays.asList(
            entries.toArray(
                ZipArchiveEntry.EMPTY_ARRAY)); // Bug 3: Use entriesList instead of allEntries
    Collections.sort(entriesList, offsetComparator);
