...
/**
 * {@link CompressorInputStream} implementation to decode Zstandard encoded stream. Library relies
...
public class ZstdCompressorInputStream extends CompressorInputStream
  ...
  /**
   * Creates a new input stream that decompresses zstd-compressed data from the specific input
   * stream
   *
   * @param in the input stream of compressed data
   * @param bufferPool a configuration of zstd-jni that allows users to customize how buffers are
   *     recycled. Either a {@link com.github.luben.zstd.NoPool} or a {@link
   *     com.github.luben.zstd.RecyclingBufferPool} is allowed here.
   * @throws IOException if an IO error occurs.
   */
  public ZstdCompressorInputStream(final InputStream in, final BufferPool bufferPool)
      throws IOException {
