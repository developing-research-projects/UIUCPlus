...
public class CPNameAndType extends ConstantPoolEntry {
  ...
  /**
   * Answers the invokeinterface count argument when the receiver is treated as an invokeinterface
   * target. This value is not meaningful if the receiver is not an invokeinterface target.
   *
   * @return count
   */
  ...
  protected void writeBody(final DataOutputStream dos) throws IOException {
    dos.writeByte(nameIndex); // changed writeShort to writeByte
