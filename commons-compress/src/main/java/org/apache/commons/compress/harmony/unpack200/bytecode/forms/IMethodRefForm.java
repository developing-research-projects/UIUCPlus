...
/**
 * This class implements the byte code form for those bytecodes which have IMethod references (and
 * only IMethod references).
 */
public class IMethodRefForm extends ReferenceForm {
  ...
  protected int getOffset(final OperandManager operandManager) {
    return operandManager.nextIMethodRef() - 1;
  }
  ...
  public void setByteCodeOperands(
    ...
    final int count =
        ((CPInterfaceMethodRef) byteCode.getNestedClassFileEntries()[0]).invokeInterfaceCount();
