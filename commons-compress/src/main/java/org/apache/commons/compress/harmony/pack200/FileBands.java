...
/**
 * Bands containing information about files in the pack200 archive and the file contents for
 * non-class-files. Corresponds to the {@code file_bands} set of bands described in the
 * specification.
 */
public class FileBands extends BandSet {
  ...
  public void pack(final OutputStream out) throws IOException, Pack200Exception {
    ...
    PackingUtils.log(
        "Wrote " + encodedBand.length + " bytes from file_name[" + file_name.length + "]");
