...
/**
 * A run codec is a grouping of two nested codecs; K values are decoded from the first codec, and
 * the remaining codes are decoded from the remaining codec. Note that since this codec maintains
