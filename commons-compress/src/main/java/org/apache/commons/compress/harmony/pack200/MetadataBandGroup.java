    ...
    if (hasContent()) {
      ...
      if (!type.equals("AD")) {
        if (type.indexOf('P') != -1) {
          ...
          encodedBand =
              encodeBandInt(contextStr + "_" + type + " param_NB", param_NB.toArray(), Codec.BYTE1);
        ...
        encodedBand =
            encodeBandInt(contextStr + "_" + type + " anno_N", anno_N.toArray(), Codec.UNSIGNED5);
        out.write(encodedBand);
        PackingUtils.log(
            "Wrote "
                + encodedBand.length
        ...
        encodedBand =
            encodeBandInt(
                contextStr + "_" + type + " type_RS", cpEntryListToArray(type_RS), Codec.UNSIGNED5);
        out.write(encodedBand);
        PackingUtils.log(
            "Wrote "
                + encodedBand.length
        ...
        encodedBand =
            encodeBandInt(contextStr + "_" + type + " pair_N", pair_N.toArray(), Codec.UNSIGNED5);
        out.write(encodedBand);
        PackingUtils.log(
            "Wrote "
                + encodedBand.length
        ...
        encodedBand =
            encodeBandInt(
                contextStr + "_" + type + " name_RU", cpEntryListToArray(name_RU), Codec.UNSIGNED5);
        out.write(encodedBand);
        PackingUtils.log(
            "Wrote "
                + encodedBand.length
      ...
      encodedBand =
          encodeBandInt(
              contextStr + "_" + type + " caseI_KI", cpEntryListToArray(caseI_KI), Codec.UNSIGNED5);
      out.write(encodedBand);
      PackingUtils.log(
          "Wrote "
              + encodedBand.length
      ...
      encodedBand =
          encodeBandInt(
              contextStr + "_" + type + " caseD_KD", cpEntryListToArray(caseD_KD), Codec.UNSIGNED5);
      out.write(encodedBand);
      PackingUtils.log(
          "Wrote "
              + encodedBand.length
      ...
      encodedBand =
          encodeBandInt(
              contextStr + "_" + type + " caseF_KF", cpEntryListToArray(caseF_KF), Codec.UNSIGNED5);
      out.write(encodedBand);
      PackingUtils.log(
          "Wrote "
              + encodedBand.length
      ...
      encodedBand =
          encodeBandInt(
              contextStr + "_" + type + " caseJ_KJ", cpEntryListToArray(caseJ_KJ), Codec.UNSIGNED5);
      out.write(encodedBand);
      PackingUtils.log(
          "Wrote "
              + encodedBand.length
      ...
      encodedBand =
          encodeBandInt(
              contextStr + "_" + type + " casec_RS", cpEntryListToArray(casec_RS), Codec.UNSIGNED5);
      out.write(encodedBand);
      PackingUtils.log(
          "Wrote "
              + encodedBand.length
      ...
      encodedBand =
          encodeBandInt(
              contextStr + "_" + type + " cases_RU", cpEntryListToArray(cases_RU), Codec.UNSIGNED5);
      out.write(encodedBand);
      PackingUtils.log(
          "Wrote "
              + encodedBand.length
      ...
      encodedBand =
          encodeBandInt(
              contextStr + "_" + type + " casearray_N", casearray_N.toArray(), Codec.UNSIGNED5);
      out.write(encodedBand);
      PackingUtils.log(
          "Wrote "
              + encodedBand.length
      ...
      encodedBand =
          encodeBandInt(
              ...
              cpEntryListToArray(nesttype_RS),
              Codec.UNSIGNED5);
      out.write(encodedBand);
      PackingUtils.log(
          "Wrote "
      ...
      encodedBand =
          encodeBandInt(
              contextStr + "_" + type + " nestpair_N", nestpair_N.toArray(), Codec.UNSIGNED5);
      out.write(encodedBand);
      PackingUtils.log(
          "Wrote "
              + encodedBand.length
      ...
      encodedBand =
          encodeBandInt(
              ...
              cpEntryListToArray(nestname_RU),
              Codec.UNSIGNED5);
      out.write(encodedBand);
      PackingUtils.log(
          "Wrote "
