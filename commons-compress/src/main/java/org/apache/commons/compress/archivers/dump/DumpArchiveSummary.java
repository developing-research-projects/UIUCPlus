...
/**
 * This class represents identifying information about a Dump archive volume. It consists the
 * archive's dump date, label, hostname, device name and possibly last mount point plus the volume's
 * volume id andfirst record number.
 *
 * <p>For the corresponding C structure see the header of {@link DumpArchiveEntry}.
 */
public class DumpArchiveSummary {
  ...
  public boolean equals(final Object obj) {
    ...
    return Objects.equals(devname, other.devname)
        && dumpDate == other.dumpDate
  ...
  /**
   * Get the level of this dump. This is a number between 0 and 9, inclusive, and a level 0 dump is
   * a complete dump of the partition. For any other dump 'n' this dump contains all files that have
   * changed since the last dump at this level or lower. This is used to support different levels of
   * incremental backups.
   *
   * @return dump level
   */
  ...
  /**
   * Is this volume compressed? N.B., individual blocks may or may not be compressed. The first
   * block is never compressed.
   *
