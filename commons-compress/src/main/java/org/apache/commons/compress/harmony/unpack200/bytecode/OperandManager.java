...
/**
 * This class keeps track of operands used. It provides API to let other classes get next elements,
 * and also knows about which classes have been used recently in super, this and new references.
 */
public class OperandManager {
  ...
  public int nextMethodRef() {
    return bcMethodRef[++bcMethodRefIndex] + 1;
  }
