...
/**
 * This class is an extension of the ClassRefForm. It has two purposes: 1. To keep track of the last
 * type used in a new() instruction in the current class. 2. To allow the sender to create instances
 * of either a specified class (which then becomes the new class) or the last used new class.
 */
public class NewClassRefForm extends ClassRefForm {
  ...
  public void setByteCodeOperands(
    ...
    if (offset == 0) {
      ...
      nested =
          new ClassFileEntry[] {globalPool.getClassPoolEntry(operandManager.getCurrentClass())};
