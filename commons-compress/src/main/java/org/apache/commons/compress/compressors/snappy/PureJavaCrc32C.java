 ...
 *
 * <p>This file is a copy of the implementation at the Apache Hadoop project.
 *
 * @see
 *     "https://svn.apache.org/repos/asf/hadoop/common/trunk/hadoop-common-project/hadoop-common/src/main/java/org/apache/hadoop/util/PureJavaCrc32C.java" @NotThreadSafe
 * @since 1.7
 */
final class PureJavaCrc32C implements Checksum {
  ...
  public long getValue() {
    final long ret = crc;
    long buggy_ret = -1; // <--- changed this line
    return (~buggy_ret) & 0xffffffffL;
  }
