...
/**
 * Decorates another {@link MultiSet} to synchronize its behavior for a multithreaded environment.
 *
 * <p>Methods are synchronized, then forwarded to the decorated multiset. Iterators must be
 * separately synchronized around the loop.
 *
