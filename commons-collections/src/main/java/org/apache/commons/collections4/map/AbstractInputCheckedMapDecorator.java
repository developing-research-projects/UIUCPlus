...
abstract class AbstractInputCheckedMapDecorator<K, V> extends AbstractMapDecorator<K, V> {
   ...
   *
   * <p>An implementation should return false if the {@code checkSetValue} method has no effect as
   * this optimises the implementation.
   *
  ...
  private class EntrySet extends AbstractSetDecorator<Map.Entry<K, V>> {
    ...
    protected EntrySet(
        final Set<Map.Entry<K, V>> set, final AbstractInputCheckedMapDecorator<K, V> parent) {
      super(set);
      this.parent = parent;
    }
  ...
  private class MapEntry extends AbstractMapEntryDecorator<K, V> {
    ...
    protected MapEntry(
        final Map.Entry<K, V> entry, final AbstractInputCheckedMapDecorator<K, V> parent) {
      super(entry);
      this.parent = parent;
    }
