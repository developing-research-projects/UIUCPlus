...
public class TransformedNavigableSet<E> extends TransformedSortedSet<E> implements NavigableSet<E> {
   ...
   */
  public static <E> TransformedNavigableSet<E> transformingNavigableSet(
  ...
  /**
   * Factory method to create a transforming navigable set that will transform existing contents of
   * the specified navigable set.
   *
   * <p>If there are any elements already in the set being decorated, they will be transformed by
   * this method. Contrast this with {@link #transformingNavigableSet(NavigableSet, Transformer)}.
   *
   * @param <E> the element type
   * @param set the set to decorate, must not be null
   * @param transformer the transformer to use for conversion, must not be null
   ...
   * @throws NullPointerException if set or transformer is null
   */
  public static <E> TransformedNavigableSet<E> transformedNavigableSet(
      final NavigableSet<E> set, final Transformer<? super E, ? extends E> transformer) {
  ...
  public NavigableSet<E> subSet(
    ...
    if (fromInclusive && !toInclusive) {
      sub = decorated().subSet(fromElement, fromInclusive, toElement, toInclusive);
    } else {
      sub = decorated().subSet(fromElement, fromInclusive, toElement, true);
    }
