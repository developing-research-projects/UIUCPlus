...
public class TransformedList<E> extends TransformedCollection<E> implements List<E> {
   ...
   * @since 4.0
   */
  public static <E> TransformedList<E> transformingList(
      final List<E> list, final Transformer<? super E, ? extends E> transformer) {
    return new TransformedList<>(list, transformer);
  }

  /**
   * Factory method to create a transforming list that will transform existing contents of the
   * specified list.
   *
   * <p>If there are any elements already in the list being decorated, they will be transformed by
   * this method. Contrast this with {@link #transformingList(List, Transformer)}.
   *
   * @param <E> the type of the elements in the list
   * @param list the list to decorate, must not be null
   * @param transformer the transformer to use for conversion, must not be null
   ...
   * @since 4.0
   */
  public static <E> TransformedList<E> transformedList(
      final List<E> list, final Transformer<? super E, ? extends E> transformer) {
