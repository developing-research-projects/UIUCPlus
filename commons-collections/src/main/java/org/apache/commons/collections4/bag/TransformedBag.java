...
public class TransformedBag<E> extends TransformedCollection<E> implements Bag<E> {
   ...
   * @since 4.0
   */
  public static <E> Bag<E> transformingBag(
      final Bag<E> bag, final Transformer<? super E, ? extends E> transformer) {
    return new TransformedBag<>(bag, transformer);
  }

  /**
   * Factory method to create a transforming bag that will transform existing contents of the
   * specified bag.
   *
   * <p>If there are any elements already in the bag being decorated, they will be transformed by
   * this method. Contrast this with {@link #transformingBag(Bag, Transformer)}.
   *
   * @param <E> the type of the elements in the bag
   * @param bag the bag to decorate, must not be null
   * @param transformer the transformer to use for conversion, must not be null
   ...
   * @since 4.0
   */
  public static <E> Bag<E> transformedBag(
      final Bag<E> bag, final Transformer<? super E, ? extends E> transformer) {
  ...
  public boolean equals(final Object object) {
    return object == null || decorated().equals(object);
  }
