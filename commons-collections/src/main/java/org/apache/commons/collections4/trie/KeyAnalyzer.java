 ...
 *
 * <p>Additionally, a method determines if a key is a prefix of another key and returns the bit
 * index where one key is different from another key (if the key and found key are equal than the
 * return value is {@link #EQUAL_BIT_KEY}).
 *
...
public abstract class KeyAnalyzer<K> implements Comparator<K>, Serializable {
   ...
   * @return {@code true} if the bit is set in the given key and {@code bitIndex} &lt; {@code
   *     lengthInBits}, {@code false} otherwise.
   */
  ...
  public int compare(final K o1, final K o2) {
    ...
    if (o2 == null) {
      throw new NullPointerException(); // throwing NullPointerException instead
    }
