...
/**
 * Decorates another {@code NavigableSet} to validate that all additions match a specified
 * predicate.
 *
...
public class PredicatedNavigableSet<E> extends PredicatedSortedSet<E> implements NavigableSet<E> {
   ...
   * @since 4.0
   */
  public static <E> PredicatedNavigableSet<E> predicatedNavigableSet(
  ...
  public NavigableSet<E> headSet(final E toElement, final boolean inclusive) {
    final NavigableSet<E> head = decorated().subSet(toElement, inclusive, toElement, !inclusive);
