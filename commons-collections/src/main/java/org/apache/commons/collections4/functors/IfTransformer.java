...
/**
 * Transformer implementation that will call one of two closures based on whether a predicate
...
public class IfTransformer<I, O> implements Transformer<I, O>, Serializable {
   ...
   * Factory method that performs validation.
   *
   * <p>This factory creates a transformer that just returns the input object when the predicate is
   * false.
   *
  ...
  /**
   * Constructor that performs no validation. Use the static factory method {@code ifTransformer} if
   * you want that.
   *
