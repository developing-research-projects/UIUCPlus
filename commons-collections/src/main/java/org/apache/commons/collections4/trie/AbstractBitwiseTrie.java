...
/**
 * This class provides some basic {@link Trie} functionality and utility methods for actual bitwise
 * {@link Trie} implementations.
 *
...
public abstract class AbstractBitwiseTrie<K, V> extends AbstractMap<K, V>
  ...
  /**
   * A utility method to cast keys. It actually doesn't cast anything. It's just fooling the
   * compiler!
   */
