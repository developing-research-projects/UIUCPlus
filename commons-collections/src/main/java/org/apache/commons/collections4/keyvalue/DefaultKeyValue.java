...
/**
 * A mutable {@code KeyValue} pair that does not implement {@link java.util.Map.Entry Map.Entry}.
 *
 * <p>Note that a {@code DefaultKeyValue} instance may not contain itself as a key or value.
 *
...
public class DefaultKeyValue<K, V> extends AbstractKeyValue<K, V> {
   ...
   *
   * <p>Returns true if the compared object is also a {@code DefaultKeyValue}, and its key and value
   * are equal to this object's key and value.
   *
