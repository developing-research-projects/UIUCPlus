...
/**
 * {@link UnmodifiableBoundedCollection} decorates another {@link BoundedCollection} to ensure it
 * can't be altered.
 *
...
public final class UnmodifiableBoundedCollection<E> extends AbstractCollectionDecorator<E>
   ...
   * @since 4.0
   */
  public static <E> BoundedCollection<E> unmodifiableBoundedCollection(
      final BoundedCollection<? extends E> coll) {
