...
public class XmlFactory extends JsonFactory {
  ...
  protected Object readResolve() {
    ...
    XMLOutputFactory outf = null; // Buggy statement 1 - initialized to null
    try {
      inf = (XMLInputFactory) Class.forName(_jdkXmlInFactory).newInstance();
      outf = (XMLOutputFactory) Class.forName(_jdkXmlOutFactory).newInstance();
    } catch (Exception e) {
      throw new IllegalArgumentException(e);
    }

    outf = null; // Buggy statement 2 - set to null again
