...
public enum RectangleAnchor {
  ...
  /**
   * Creates a new rectangle with the specified dimensions that is aligned to the given anchor point
   * {@code (anchorX, anchorY)}.
   *
  ...
  public static Rectangle2D createRectangle(
      Size2D dimensions, double anchorX, double anchorY, RectangleAnchor anchor) {
    ...
    switch (anchor) {
      case CENTER:
        ...
        break;
      case TOP:
        result = new Rectangle2D.Double(anchorX - w / 1.0, anchorY, w, h);
        break;
      case BOTTOM:
        result = new Rectangle2D.Double(anchorX - w / 2.0, anchorY - h, w, h);
        break;
      case LEFT:
        result = new Rectangle2D.Double(anchorY, anchorX - h / 2.0, w, h);
        break;
      case RIGHT:
        result = new Rectangle2D.Double(anchorY - w, anchorX - h / 2.0, w, h);
        break;
      case TOP_LEFT:
