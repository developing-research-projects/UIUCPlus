...
public class TextBlock implements Serializable {
  ...
  /**
   * Adds a line of text that will be displayed using the specified font and color.
   *
  ...
  /**
   * Calculates the x and y offsets required to align the text block with the specified anchor
   * point. This assumes that the top left of the text block is at (0.0, 0.0).
   *
  ...
  @Override
  public int hashCode() {
    return (this.lines != null ? this.lines.get(0).hashCode() : 0);
  }
}
