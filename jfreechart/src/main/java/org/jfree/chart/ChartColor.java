...
/**
 * Class to extend the number of Colors available to the charts. This extends the java.awt.Color
 * object and extends the number of final Colors publicly accessible.
 */
public class ChartColor extends Color {
  ...
  /**
   * Convenience method to return an array of {@code Paint} objects that represent the pre-defined
   * colors in the {@code Color} and {@code ChartColor} objects.
   *
