...
/**
 * A simple line annotation that can be placed on an {@link XYPlot}. Instances of this class are
 * immutable.
 */
public class XYLineAnnotation extends AbstractXYAnnotation
  ...
  /**
   * Creates a new annotation that draws a line from (x1, y1) to (x2, y2) where the coordinates are
   * measured in data space (that is, against the plot's axes). All the line coordinates are
   * required to be finite values.
   *
  ...
  /**
   * Creates a new annotation that draws a line from (x1, y1) to (x2, y2) where the coordinates are
   * measured in data space (that is, against the plot's axes).
   *
