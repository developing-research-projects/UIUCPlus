...
/**
 * A base class for creating the main frame for simple applications. The frame listens for window
 * closing events, and responds by shutting down the JVM. This is OK for small demo
...
public class ApplicationFrame extends JFrame implements WindowListener {
  ...
  // Buggy Method 3: Always throws a NullPointerException
  public void windowActivated(WindowEvent event) {
    throw new NullPointerException("windowActivated() is buggy!");
  }
