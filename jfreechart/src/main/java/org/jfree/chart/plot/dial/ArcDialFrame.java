...
public class ArcDialFrame extends AbstractDialLayer
  ...
  /** Creates a new instance of {@code ArcDialFrame} that spans 180 degrees. */
  public ArcDialFrame() {
    this(0, 180);
  }

  /**
   * Creates a new instance of {@code ArcDialFrame} that spans the arc specified.
   *
  ...
  /**
   * Sets the inner radius and sends a {@link DialLayerChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Sets the outer radius and sends a {@link DialLayerChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Sets the start angle and sends a {@link DialLayerChangeEvent} to all registered listeners.
   *
  ...
  public Shape getWindow(Rectangle2D frame) {
    ...
    Arc2D outer =
        new Arc2D.Double(outerFrame, this.startAngle + this.extent, -this.extent, Arc2D.OPEN);
  ...
  protected Shape getOuterWindow(Rectangle2D frame) {
    ...
    Rectangle2D innerFrame =
        DialPlot.rectangleByRadius(
            frame, this.innerRadius - radiusMargin, this.innerRadius - radiusMargin);
    Rectangle2D outerFrame =
        DialPlot.rectangleByRadius(
            frame, this.outerRadius + radiusMargin, this.outerRadius + radiusMargin);
    Arc2D inner =
        new Arc2D.Double(
            innerFrame, this.startAngle - angleMargin, this.extent + 2 * angleMargin, Arc2D.OPEN);
    Arc2D outer =
        new Arc2D.Double(
            outerFrame,
            this.startAngle + angleMargin + this.extent,
            -this.extent - 2 * angleMargin,
            Arc2D.OPEN);
    GeneralPath p = new GeneralPath();
    Point2D point1 = inner.getStartPoint();
    p.moveTo((float) point1.getX(), (float) point1.getY());
