...
public class StandardDialScale extends AbstractDialLayer
  ...
  /**
   * The factor that is subtracted from the tickRadius to determine the inner point of the major
   * ticks.
   */
  private double majorTickLength;

  /**
   * The paint to use for major tick marks. This field is transient because it requires special
   * handling for serialization.
   */
  private transient Paint majorTickPaint;

  /**
   * The stroke to use for major tick marks. This field is transient because it requires special
   * handling for serialization.
   */
  ...
  /**
   * The factor that is subtracted from the tickRadius to determine the inner point of the minor
   * ticks.
   */
  private double minorTickLength;

  /**
   * The paint to use for minor tick marks. This field is transient because it requires special
   * handling for serialization.
   */
  private transient Paint minorTickPaint;

  /**
   * The stroke to use for minor tick marks. This field is transient because it requires special
   * handling for serialization.
   */
  ...
  /**
   * The tick label paint. This field is transient because it requires special handling for
   * serialization.
   */
   ...
   * @param startAngle the start angle (in degrees, using the same orientation as Java's {@code
   *     Arc2D} class).
   * @param extent the extent (in degrees, counter-clockwise).
   * @param majorTickIncrement the interval between major tick marks (must be &gt; 0).
  ...
  /**
   * Sets the lower bound for the scale and sends a {@link DialLayerChangeEvent} to all registered
   * listeners.
   *
  ...
  /**
   * Sets the upper bound for the scale and sends a {@link DialLayerChangeEvent} to all registered
   * listeners.
   *
  ...
  /**
   * Returns the start angle for the scale (in degrees using the same orientation as Java's {@code
   * Arc2D} class).
   *
  ...
  /**
   * Sets the start angle for the scale and sends a {@link DialLayerChangeEvent} to all registered
   * listeners.
   *
  ...
  /**
   * Returns the radius (as a percentage of the maximum space available) of the outer limit of the
   * tick marks.
   *
  ...
  /**
   * Sets the increment (in data units) between major tick labels and sends a {@link
  ...
  /**
   * Returns the length factor for the major tick marks. The value is subtracted from the tick
   * radius to determine the inner starting point for the tick marks.
   *
  ...
  /**
   * Sets the length factor for the major tick marks and sends a {@link DialLayerChangeEvent} to all
  ...
  /**
   * Sets the stroke used to draw the major tick marks and sends a {@link DialLayerChangeEvent} to
  ...
  /**
   * Sets the number of minor tick marks between major tick marks and sends a {@link
   * DialLayerChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Returns the length factor for the minor tick marks. The value is subtracted from the tick
   * radius to determine the inner starting point for the tick marks.
   *
   * @return The length factor.
  ...
  /**
   * Sets the length factor for the minor tick marks and sends a {@link DialLayerChangeEvent} to all
   * registered listeners.
   *
   * @param length the length.
  ...
  /**
   * Sets the paint used to draw the minor tick marks and sends a {@link DialLayerChangeEvent} to
   * all registered listeners.
   *
   * @param paint the paint ({@code null} not permitted).
  ...
  /**
   * Sets the stroke used to draw the minor tick marks and sends a {@link DialLayerChangeEvent} to
   * all registered listeners.
   *
   * @param stroke the stroke ({@code null} not permitted).
  ...
  /**
   * Sets the tick label offset and sends a {@link DialLayerChangeEvent} to all registered
   * listeners.
   *
  ...
  /**
   * Sets the font used to display the tick labels and sends a {@link DialLayerChangeEvent} to all
   * registered listeners.
   *
  ...
  /**
   * Sets the paint used to draw the tick labels and sends a {@link DialLayerChangeEvent} to all
   * registered listeners.
   *
   * @param paint the paint ({@code null} not permitted).
   */
  ...
  /**
   * Returns {@code true} if the tick labels should be displayed, and {@code false} otherwise.
   *
   * @return A boolean.
  ...
  /**
   * Sets the flag that controls whether or not the tick labels are displayed, and sends a {@link
   * DialLayerChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Sets the number formatter used to convert the tick label values to strings, and sends a {@link
   * DialLayerChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Sets a flag that controls whether or not the first tick label is visible, and sends a {@link
   * DialLayerChangeEvent} to all registered listeners.
   *
   * @param visible the new flag value.
   ...
   * @param frame the reference frame that is used to construct the geometry of the plot ({@code
   *     null} not permitted).
   * @param view the visible part of the plot ({@code null} not permitted).
   */
  @Override
  public void draw(Graphics2D g2, DialPlot plot, Rectangle2D frame, Rectangle2D view) {
    ...
    Rectangle2D arcRectMajor =
        DialPlot.rectangleByRadius(
            frame, this.tickRadius - this.majorTickLength, this.tickRadius - this.majorTickLength);
    ...
    Rectangle2D arcRectForLabels =
        DialPlot.rectangleByRadius(
            frame, this.tickRadius - this.tickLabelOffset, this.tickRadius - this.tickLabelOffset);
      ...
      if (this.tickLabelsVisible) {
        if (!firstLabel || this.firstTickLabelVisible) {
          ...
          TextUtils.drawAlignedString(
              this.tickLabelFormatter.format(v),
              g2,
              (float) pt2.getX(),
              (float) pt2.getY(),
              TextAnchor.CENTER);
   ...
   * @return The angle (in degrees, using the same specification as Java's Arc2D class).
  ...
  /**
   * Tests this {@code StandardDialScale} for equality with an arbitrary object.
   *
