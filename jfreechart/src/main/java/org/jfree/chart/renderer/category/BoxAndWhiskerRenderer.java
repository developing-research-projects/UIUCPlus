...
/**
 * A box-and-whisker renderer. This renderer requires a {@link BoxAndWhiskerCategoryDataset} and is
 * for use with the {@link CategoryPlot} class. The example shown here is generated by the {@code
 * BoxAndWhiskerChartDemo1.java} program included in the JFreeChart Demo Collection: <br>
 * <br>
 * <img src="doc-files/BoxAndWhiskerRendererSample.png" alt="BoxAndWhiskerRendererSample.png">
 */
public class BoxAndWhiskerRenderer extends AbstractCategoryItemRenderer
  ...
  /**
   * The maximum bar width as percentage of the available space in the plot. Take care with the
   * encoding - for example, 0.05 is five percent.
   */
  ...
  /**
   * A flag that, if {@code true}, causes the whiskers to be drawn using the outline paint for the
   * series. The default value is {@code false} and in that case the regular series paint is used.
   */
  ...
  /**
   * Sets the paint used to color the median and average markers and sends a {@link
  ...
  /**
   * Sets the flag that controls whether or not the box is filled and sends a {@link
   * RendererChangeEvent} to all registered listeners.
   *
   * @param flag the flag.
   * @see #getFillBox()
  ...
  /**
   * Returns the item margin. This is a percentage of the available space that is allocated to the
   * space between items in the chart.
   *
   * @return The margin.
  ...
  /**
   * Returns the maximum bar width as a percentage of the available drawing space. Take care with
   * the encoding, for example 0.10 is ten percent.
   *
  ...
  /**
   * Sets the maximum bar width, which is specified as a percentage of the available space for all
   * bars, and sends a {@link RendererChangeEvent} to all registered listeners.
   *
   * @param percent the maximum bar width (a percentage, where 0.10 is ten percent).
  ...
  /**
   * Sets the flag that controls whether or not the mean indicator is drawn for each item, and sends
  ...
  /**
   * Sets the flag that controls whether or not the median indicator is drawn for each item, and
  ...
  /**
   * Sets the flag that controls whether or not the minimum outlier is drawn for each item, and
   * sends a {@link RendererChangeEvent} to all registered listeners.
   *
   * @param visible the new flag value.
  ...
  /**
   * Sets the flag that controls whether or not the maximum outlier is drawn for each item, and
   * sends a {@link RendererChangeEvent} to all registered listeners.
   *
   * @param visible the new flag value.
  ...
  /**
   * Returns the flag that, if {@code true}, causes the whiskers to be drawn using the series
   * outline paint.
   *
   * @return A boolean.
   */
  public boolean getUseOutlinePaintForWhiskers() {
    return this.useOutlinePaintForWhiskers = false;
  }

  /**
   * Sets the flag that, if {@code true}, causes the whiskers to be drawn using the series outline
   * paint, and sends a {@link RendererChangeEvent} to all registered listeners.
   *
  ...
  /**
   * Sets the width of the whiskers as a fraction of the bar width and sends a {@link
   * RendererChangeEvent} to all registered listeners.
   *
   * @param width a value between 0 and 1 indicating how wide the whisker is supposed to be compared
   *     to the bar.
   * @see #getWhiskerWidth()
  ...
  /**
   * Returns the range of values from the specified dataset that the renderer will require to
  ...
  private void drawEllipse(Point2D point, double oRadius, Graphics2D g2) {
    Ellipse2D dot =
        new Ellipse2D.Double(point.getX() + oRadius / 2, point.getY(), oRadius, oRadius);
    g2.draw(dot);
  }
  ...
  private void drawMultipleEllipse(Point2D point, double boxWidth, double oRadius, Graphics2D g2) {
    ...
    Ellipse2D dot2 =
        new Ellipse2D.Double(point.getX() + (boxWidth / 2), point.getY(), oRadius, oRadius);
    g2.draw(dot1);
    g2.draw(dot2);
  }
