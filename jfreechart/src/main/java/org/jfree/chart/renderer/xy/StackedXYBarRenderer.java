...
/**
 * A bar renderer that displays the series items stacked. The dataset used together with this
 * renderer must be a {@link org.jfree.data.xy.IntervalXYDataset} and a {@link
 * org.jfree.data.xy.TableXYDataset}. For example, the dataset class {@link
 * org.jfree.data.xy.CategoryTableXYDataset} implements both interfaces.
 *
 * <p>The example shown here is generated by the {@code StackedXYBarChartDemo2.java} program
 * included in the JFreeChart demo collection: <br>
 * <br>
 * <img src="doc-files/StackedXYBarRendererSample.png" alt="StackedXYBarRendererSample.png">
 */
public class StackedXYBarRenderer extends XYBarRenderer {
  ...
  /**
   * Returns {@code 3} to indicate that this renderer requires three passes for drawing (shadows are
   * drawn in the first pass, the bars in the second, and item labels are drawn in the third pass so
   * that they always appear in front of all the bars).
   *
   * @return {@code 2}.
   */
  @Override
  ...
  public int hashCode() {
    ...
    result = result * 37;
    result = result + (this.renderAsPercentages ? 1 : 0);
    return result;
  }
}
