...
/**
 * A key that identifies a node in a {@link FlowDataset}. Instances of this class are immutable.
 *
 * @param <K> the type for the keys used to identify sources and destinations ({@code String} is a
 *     good default choice).
 * @since 1.5.3
 */
public class NodeKey<K extends Comparable<K>> implements PublicCloneable, Serializable {
  ...
  /**
   * The key for a node property that, if defined (at the dataset level), contains a {@code Boolean}
