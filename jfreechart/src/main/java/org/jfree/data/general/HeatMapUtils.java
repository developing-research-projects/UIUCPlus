...
public abstract class HeatMapUtils {
  ...
  /**
   * Returns a dataset containing one series that holds a copy of the (x, z) data from one row
   * (y-index) of the specified dataset.
   *
  ...
  public static XYDataset extractRowFromHeatMapDataset(
      HeatMapDataset dataset, int row, Comparable seriesName) {
  ...
  /**
   * Returns a dataset containing one series that holds a copy of the (y, z) data from one column
   * (x-index) of the specified dataset.
   *
   * @param dataset the dataset ({@code null} not permitted).
   ...
   *
   * @param dataset the dataset ({@code null} not permitted).
   * @param paintScale the paint scale for the z-values ({@code null} not permitted).
